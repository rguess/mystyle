...
public class WorkFlowController extends BaseWorkFlowController{
	...
	public Map<String, Object> myprocess() {
		...
		Page<Map<String, String>> page = workflowService.pageProcessceByUserId(
				current_user.getId().toString(), new Page<Map<String, String>>(
						new PageRequest()));
	...
	public Map<String, Object> toTasks() {
		current_user = (User) session.getAttribute(Constants.CURRENT_USER);
		Page<Map<String, String>> page = workflowService.getTodoTasks(
				current_user.getLoginId(), new Page<Map<String, String>>(
